...
# 16-GPU Parallel Non-IID Expert Training - All models simultaneously
...
#SBATCH -o logs/train_noniid_16gpu_%j.out
...
echo "=========================================="
echo "16-GPU Non-IID Expert Training"
...
srun --ntasks=16 bash -c '
    ...
    echo "Starting Non-IID training: $MODEL Expert $EXPERT_ID"
...
echo "🏁 All 16 Non-IID experts training completed!"
